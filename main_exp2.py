...
#model.load_state_dict(torch.load("./exp2_models/exp2_lr_5e-3_bs_64_epoch_1"))
#model.to(device)

print("calculating val set metrics")
#print(evaluate(model, val_dataloader, learning_rate, 64, 1, "val"))    
...
#print(evaluate(model, test_dataloader, learning_rate, 64, 1, "test"))  
print(evaluate(bert_classifier, test_dataloader, learning_rate, 32, 1, "test"))
#print("done with test set metrics")

#learning_rate = 5e-5
#model = BertClassifier(outputDim=6)
#model.load_state_dict(torch.load("./exp2_models/exp2_lr_5e-5_bs_64_epoch_0"))
#model.to(device)

#print(evaluate(model, val_dataloader, learning_rate, 64, 0, "val")) 
#print("done with val set metrics")

#print(evaluate(model, test_dataloader, learning_rate, 64, 0, "test"))
#print("done with test set metrics") 
