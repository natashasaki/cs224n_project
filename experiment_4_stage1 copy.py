...
def initialize(learning_rate=5e-5):
    ...
    bert_classifier = BertClassifier(outputDim=8) # 6 conditions + 8 emotions
...
def train(model, optimizer,train_labels, scheduler, train_dataloader, val_dataloader=None, epochs=4, evaluation=False):
    ...
    for epoch_i in range(epochs):
        ...
        torch.save(model.state_dict(), f'./exp4_online/exp4_weights_bs_64_lr_5e-4_epoch_{epoch_i}.model')
        print("\n")
...
if os.path.exists("./data/train_dataloader_exp4_1.pkl.pkl"):
    train_dataloader = pickle.load(open("./data/train_dataloader_exp4_1.pkl.pkl", "rb"))
    val_dataloader = pickle.load(open("./data/val_dataloader_exp4_1.pkl.pkl", "rb"))
    test_dataloader = pickle.load(open("./data/test_dataloader.pkl", "rb"))

    train_labels = pickle.load(open("./data/train_labels_exp4_1.pkl.pkl", "rb"))
    val_labels = pickle.load(open("./data/val_labels_exp4_1.pkl.pkl", "rb"))
    test_labels = pickle.load(open("./data/test_labels_exp4_1.pkl.pkl", "rb"))
else:
