...
def RedditToConditionDataset(Dataset): 
    def __init__(self, path, max_len, ):
        ...
        data = pd.read_csv("./dataset/dataset_exp2.csv", names=header_list,)
...
def loadData(): 
    ...
    # for local testing and training
#    dep= data.loc[data['condition_label'] == "[1,0,0,0,0,0]"].head(50)
#    anx= data.loc[data['condition_label'] == "[0,1,0,0,0, 0]"].head(100)
#    bp= data.loc[data['condition_label'] == "[0,0,1,0,0, 0]"].head(50)
#    adhd= data.loc[data['condition_label'] == "[0,0,0,0,1,0]"].head(50)
#    add= data.loc[data['condition_label'] == "[0,0,0,1,0,0]"].head(50)
#    oth= data.loc[data['condition_label'] == "[0,0,0,0,0,1]"].head(100)
